          ...
          <div className="block overflow-hidden">
            <div className="my-[1.66667vw] box-border block bg-white px-[1.66667vw]">
              ...
              <article className="block">
                ...
                <div className="relative box-border pb-[1.666667vw]">
                  <div className="box-border">
                    <div className="flex flex-row items-center justify-between py-[1.166667vw] text-[2.333333vw]">
                    ...
                    <div className="box-border">
                      <div className="relative h-auto bg-white pt-[1.166667vw]">
                        <div className="flex flex-row items-center overflow-hidden text-[2.333333vw]">
            ...
            <div className="box-border bg-white">
              <div className="mb-[1.666667vw] px-[1.666667vw] py-[2.333333vw] text-[#222]">
                <div className="text-[2.666667vw] font-medium ">
                  Chi Tiết Thanh Toán
                </div>
                <div className="box-border">
                  <div className="flex flex-row items-center justify-between py-[1.1666667vw]">
                    <label className="text-[2.333333vw] ">
                      Tổng Tiền Hàng
                    ...
                    <div className="box-border flex flex-1 flex-row items-center justify-end pl-[1.666667vw]">
                      <span className="box-border text-[2.666667vw] ">
                        90K<span className="ml-[0.333333vw] text-[2vw]">đ</span>
                      </span>
                    </div>
                  </div>
                  <div className="flex flex-row items-center justify-between py-[1.1666667vw]">
                    ...
                    <div className="box-border flex flex-1 flex-row items-center justify-end pl-[1.666667vw]">
                      <span className="box-border text-[2.666667vw] text-[#222]">
                        60K<span className="ml-[0.333333vw] text-[2vw]">đ</span>
                      </span>
                    </div>
                  </div>
                  <div className="flex flex-row items-center justify-between py-[1.1666667vw]">
                    <label className="text-[2.333333vw]">Tổng Thanh Toán</label>
                    <div className="box-border flex flex-1 flex-row items-center justify-end pl-[1.666667vw]">
                      <span className="box-border text-[2.666667vw] ">
                        190K
                        <span className="ml-[0.333333vw] text-[2vw]">đ</span>
                      </span>
                    </div>
                  </div>
                </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 h-[9.5vw] w-full bg-white">
        <div className="box-border p-[1.666667vw]">
          <div className="flex flex-row items-center">
            <div className="mr-[1.666667vw] flex-shrink-0 grow text-right text-[2vw] ">
              <label>
              ...
              <span className="box-border text-[4vw] font-medium text-[#FF4000]">
                190K<span className="ml-[0.333333vw] text-[3vw]">đ</span>
              </span>
            </div>
            <div className="flex-initial">
              <div className="flex">
                <button className="h-[6.1666667vw] w-[16.6666667vw] flex-1 rounded-full bg-[#ff4000] text-[2.333333vw] leading-[6.1666667vw] text-white">
                  Xác Nhận
                </button>
              </div>
            </div>
