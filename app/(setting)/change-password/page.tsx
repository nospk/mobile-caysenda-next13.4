  ...
  return (
    <form className="h-screen w-full mt-10 flex flex-col items-center" onSubmit={handleSubmit}>
      ...
      <div className=' box-border flex justify-center items-center mt-1 px-4'>
        <button type="submit" tabIndex={3} className='w-full rounded-full text-white bg-[#ff4800] hover:bg-orange-600 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-[#ff4800] dark:hover:bg-orange-800 dark:focus:ring-blue-800'>
          Lưu Mật Khẩu
        </button>
      </div>
    </form>
