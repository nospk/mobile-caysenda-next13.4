...
export default async function Page() {
	return <>
	<div className="box-border flex flex-col items-stretch w-[100vw] h-[calc(100vh-14.6667vw)] bg-[#f0f0f0]">
								...
								<div className="px-[3.2vw] flex flex-col flex-shrink-0 content-start">
									<div className="flex flex-row items-center box-broder flex-shrink-0 content-start">
										...
										<div className="flex-1 flex flex-row items-center overflow-hidden box-broder text-[2.6667vw]">
											<span className="text-[#333] truncate whitespace-nowrap block box-broder">Quần áo thời</span>{'>'}
										...
										<div className="flex flex-row items-center px-[3.2vw] flex-shrink-0 box-broder">
											...
											<div className="flex-1 items-center flex flex-row box-broder content-start flex-shrink-0">
												...
												<div className="flex flex-1 self-start content-start box-broder flex-col overflow-hidden shrink-0 w-0">
													<span className="mb-[1.6vw] whitespace-nowrap truncate text-[3.46667vw] box-broder font-medium block">Chậu hình thú</span>
												</div>
											</div>
										</div>
									</div>
									<div className="flex flex-col flex-shrink-0 box-broder">
										<div className="mt-[3.2vw] box-broder flex flex-col flex-shrink-0">
											<div className="px-[3.2vw] flex flex-col flex-shrink-0 box-broder">
												<div className="flex fex-row items-center box-broder flex-shrink-0 justify-between">
													<div className="ml-[-2.4vw] pt-[2.4vw] pb-[2.4vw] pl-[2.66667vw] flex flex-row items-center relative flex-shrink-0">
														<div className="rounded-full border-[0.26667vw] border-[#ddd] items-center content-start transition w-[5.33333vw] h-[5.33333vw]">
														</div>
														<div className="ml-[2.13333vw] relative flex flex-col flex-shrink-0 box-broder">
														</div>
													</div>
													<div className="min-h-[6.93333vw] flex-1 flex flex-row content-between items-center box-broder">
														...
														<span className="flex flex-1 flex-row content-between items-center box-broder p-[2.13333vw] bg-[#f9f9f9] text-[#666] text-[3.46667vw] rounded-lg">Thú hình Voi</span>
													</div>
												</div>
												<div className="ml-[7.46667vw] mt-[2.13333vw] min-h-[6.93333vw] flex flex-1 flex-row justify-between items-center box-broder">
													<div className="flex flex-row box-broder flex-shrink-0 text-[#FF4000]">
														<span
															className="relative box-border text-[4.26667vw] leading-[4.26667vw] font-bold"
														>
